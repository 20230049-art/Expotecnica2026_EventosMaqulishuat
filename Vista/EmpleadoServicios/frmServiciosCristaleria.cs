...
{
    public partial class frmServiciosCristaleria : Form
    {
        public frmServiciosCristaleria()
        {
            try
            {
                InitializeComponent();
                ...
                Redondeo.RedondearFig(panel1, 16);
                Redondeo.RedondearFig(panel2, 5);
            }
            catch (Exception ex){
        ...
        private void abrirForm(Form formularioAbrir)
        {
            ...
            {
                activeForm.Close();
                pnlVistaCristaleria.Controls.Remove(activeForm);
                activeForm.Dispose();
            }
            ...
            pnlVistaCristaleria.Controls.Add(formularioAbrir);
        ...
        private void MostrarServicio()
        {
            try
            {
                DataTable productos = Productos.VistaEmpleadoServicios(2);
        ...
        private void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable productos = Productos.BuscarProductosPorServicio(2, busqueda);
