...
{
    public partial class frmServiciosAnimacion : Form
    {
        public frmServiciosAnimacion()
        {
            try
            {
                InitializeComponent();
        ...
        private void abrirForm(Form formularioAbrir)
        {
            ...
            {
                activeForm.Close();
                pnlVistaAnimacion.Controls.Remove(activeForm);
                activeForm.Dispose();
            }
            ...
            pnlVistaAnimacion.Controls.Add(formularioAbrir);
        ...
        private void MostrarServicio()
        {
            try
            {
                DataTable productos = Productos.VistaEmpleadoServicios(5);
        ...
        private void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable productos = Productos.BuscarProductosPorServicio(5, busqueda);
