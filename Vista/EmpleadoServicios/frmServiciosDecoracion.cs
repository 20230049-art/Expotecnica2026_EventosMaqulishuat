...
{
    public partial class frmServiciosDecoracion : Form
    {
        public frmServiciosDecoracion()
        {
            try
            {
                InitializeComponent();
        ...
        private void abrirForm(Form formularioAbrir)
        {
            ...
            {
                activeForm.Close();
                pnlVistaDecoracion.Controls.Remove(activeForm);
                activeForm.Dispose();
            }
            ...
            pnlVistaDecoracion.Controls.Add(formularioAbrir);
        ...
        private void txtBuscar_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable productos = Productos.BuscarProductosPorServicio(6, busqueda);
